...
btnCos = Button(calc, text="log1p", width=6, height=2, font=('arial',20,'bold'),bd=4, bg = "powder blue",
...
lblDisplay =Button(calc,text="Scientific Calculator",font=('arial',30,'bold'),justify=CENTER)
